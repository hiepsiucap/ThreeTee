...
useGLTF.preload("/bucket_hat.glb");
const ShirtModel = ({
  color = "#ffffff",
  image,
  logo,
  ...
  const { scene, materials } = useGLTF("/bucket_hat.glb", true);
...
export default function DetailHat() {
      ...
      <div className=" flex flex-col md:flex-row space-x-1">
        ...
        >
          <Canvas
            ...
            camera={{
              position: [2, -7, 0], // Điều chỉnh vị trí camera
              fov: 50,
            }}
          >
        ...
        >
          <div className=" pt-6 font-roboto font-light text-3xl">
            Áo phông trắng - Cotton Chất lượng cao
          </div>
